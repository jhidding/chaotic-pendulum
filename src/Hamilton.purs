-- ------ language="PureScript" file="src/Hamilton.purs" project://lit/pendulum.md#230
module Hamilton where

import Prelude
import Data.Array ((:))

-- ------ begin <<leap-frog>>[0] project://lit/pendulum.md#107
...
instance scalarApplicative :: Applicative Scalar where
    pure a = Scalar a
-- ------ end
-- ------ begin <<leap-frog>>[1] project://lit/pendulum.md#138
type State a =
    { time :: Number
    , position :: a Number
    , momentum :: a Number }
-- ------ end
-- ------ begin <<leap-frog>>[2] project://lit/pendulum.md#147
type HamiltonianSystem a =
    { positionEquation :: State a -> a Number
    , momentumEquation :: State a -> a Number }
-- ------ end
-- ------ begin <<leap-frog>>[3] project://lit/pendulum.md#155
type Solver a = HamiltonianSystem a -> State a -> State a
-- ------ end
-- ------ begin <<leap-frog>>[4] project://lit/pendulum.md#161
...
-- ------ end
-- ------ begin <<leap-frog>>[5] project://lit/pendulum.md#172
