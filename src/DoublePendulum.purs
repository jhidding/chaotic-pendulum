-- ------ language="PureScript" file="src/DoublePendulum.purs" project://lit/pendulum.md#595
...
-- ------ begin <<double-pendulum>>[0] project://lit/pendulum.md#356
type DoublePendulum =
        { l1 :: Number
        , m1 :: Number
        , l2 :: Number
        ...
        , g  :: Number }
-- ------ end
-- ------ begin <<double-pendulum>>[1] project://lit/pendulum.md#367
...
-- ------ end
-- ------ begin <<double-pendulum>>[2] project://lit/pendulum.md#423
...
kineticEnergy z (Coordinates q) (Coordinates p) =
    ...
    where a = (z.m1 + z.m2) * (pow z.l1 2.0)
          ...
          det = a * b - c * c
-- ------ end
-- ------ begin <<double-pendulum>>[3] project://lit/pendulum.md#453
...
-- ------ end
-- ------ begin <<double-pendulum-animation>>[0] project://lit/pendulum.md#486
type Model =
    ...
    , playing     :: Boolean }
-- ------ end
-- ------ begin <<double-pendulum-animation>>[1] project://lit/pendulum.md#497
data Msg =
      AnimationFrame Number
    | TogglePlay
    | None
-- ------ end
-- ------ begin <<double-pendulum-animation>>[2] project://lit/pendulum.md#506
...
update None m = m
-- ------ end
-- ------ begin <<double-pendulum-animation>>[3] project://lit/pendulum.md#533
initModel :: Model
initModel =
    ...
    , playing: false }
-- ------ end
-- ------ begin <<double-pendulum-flare>>[0] project://lit/pendulum.md#549
...
-- ------ end
-- ------ begin <<double-pendulum-flare>>[1] project://lit/pendulum.md#557
main :: Effect Unit
main = do
    time <- animationFrame
    ...
    runFlareDrawing "double-pendulum-control" 
                    ...
                    (draw <$> model)
-- ------ end
-- ------ begin <<double-pendulum-flare>>[2] project://lit/pendulum.md#569
